...
/*
  If you want to use gmail first you have to go to the url
  https://myaccount.google.com/security => and enable two factor authentication
  then
  https://myaccount.google.com/u/0/apppasswords => create the app by example storeapp and copy the key and paste in MAILER_SECRET_PASSWORD
*/
